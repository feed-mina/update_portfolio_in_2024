    ...
    function html5Upload() {
    	...
    	sUploadURL= '/sports360/kspomaster/se/file_uploadhtml5.do';
    		...
    		try{
	    		if(!!tempFile){
					...
					*/
	    			...
	    			if (fileext != "jpg" && fileext != "png" && fileext != "bmp" && fileext != "gif" && fileext != "JPG" && fileext != "PNG" && fileext != "BMP" && fileext != "GIF"){
	    				alert ("허용된 이미지 확장자가 아닙니다.");
	    				return;
	    			}
	    			...
	    			if (!FileReader.prototype.readAsBinaryString) {
	    				FileReader.prototype.readAsBinaryString = function (fileData) {
	    				    ...
	    				    reader.onload = function (e) {
	    	    				...
	    	    				sFileInfo += "&sFileURL=data:image/"+ filename.substring(filename.lastIndexOf(".")+1)
	    	    						  + ";base64," + btoa(binary);
	    	    				makeArrayFromString(sFileInfo);
	    				    }
	    			...
	    			var options = {
        				...
        				,success : function(result){
        					reader.readAsBinaryString(result); //여기서 readAsBinaryString 실행.
        				}
        			}
        			
        			new Compressor(tempFile, options);
	    			
	    			//reader.readAsBinaryString(tempFile); //여기서 reader.onload 실행.
	...
	function onAjaxError (e){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'file_uploader_html.jsp',	//샘플 URL입니다.
